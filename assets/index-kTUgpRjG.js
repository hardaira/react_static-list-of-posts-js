...
expedita consequatur consequatur dolores quia eos et placeat`}],zc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Nc=({user:{name:e,email:t}})=>j.jsx("a",{className:"UserInfo",href:"mailto:"+t,children:e}),Pc=({comment:{name:e,email:t,body:i}})=>j.jsxs("div",{className:"CommentInfo",children:[j.jsxs("div",{className:"CommentInfo__title",children:[j.jsx("strong",{className:"CommentInfo__name",children:e})," by ",j.jsx("a",{className:"CommentInfo__email",href:"mailto:"+t,children:t})]}),j.jsx("div",{className:"CommentInfo__body",children:i})]}),Lc=({comments:e})=>j.jsx("div",{className:"CommentList",children:e.map(t=>j.jsx(Pc,{comment:t},t.id))}),Tc=({post:e})=>{const{title:t,user:i,body:n,comments:a}=e;return j.jsxs("div",{className:"PostInfo",children:[j.jsxs("div",{className:"PostInfo__header",children:[j.jsx("h3",{className:"PostInfo__title",children:t}),j.jsxs("p",{children:[" Posted by  ",i&&j.jsx(Nc,{user:i})]})]}),j.jsx("p",{className:"PostInfo__body",children:n}),j.jsx("hr",{}),a.length>0?j.jsx(Lc,{comments:a}):j.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"})]})},Mc=({posts:e})=>j.jsx(j.Fragment,{children:e.map(t=>j.jsx(Tc,{post:t},t.id))}),Rc=[{postId:1,id:1,name:"id labore ex et quam laborum",email:"Eliseo@gardner.biz",body:`laudantium enim quasi est quidem magnam voluptate ipsam eos
...
aut aut aut maxime quia temporibus ut omnis`}];function Dc(e){return zc.find(t=>t.id===e)||null}function jc(e){return Rc.filter(t=>t.postId===e)}const Oc=Cc.map(e=>({...e,user:Dc(e.userId),comments:jc(e.id)})),Fc=()=>j.jsxs("section",{className:"App",children:[j.jsx("h1",{className:"App__title",children:"Static list of posts"}),j.jsx(Mc,{posts:Oc})]});em(document.getElementById("root")).render(j.jsx(Fc,{}));
